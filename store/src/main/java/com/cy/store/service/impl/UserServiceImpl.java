...
public class UserServiceImpl implements IUserService {
    ...
    @Override
    public void changePassword(Integer uid, String username, String oldPassword, String newPassword1,String newPassword2) {
        ...
        if(newPassword1.equals(newPassword2)==false){
            throw new PasswordNotMatchException("确认密码错误");
        }
        // 将参数newPassword结合盐值加密，得到newMd5Password
        String newMd5Password = getMd5Password(newPassword1, salt);
        // 创建当前时间对象
        Date now = new Date();
