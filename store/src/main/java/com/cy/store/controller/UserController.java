...
public class UserController extends BaseController {
    ...
    */
    ...
    public JsonResult<User> login(String username, String password, HttpSession session) {
        ...
        System.out.println("Session中的uid=" + username);
    ...
    public JsonResult<Void> changePassword(String oldPassword, String newPassword1,String newPassword2,HttpSession session) {
        // 调用session.getAttribute("")获取uid和username
        Integer uid = getUidFromSession(session);
        String username = getUsernameFromSession(session);

        // 调用业务对象执行修改密码
        userService.changePassword(uid, username, oldPassword,newPassword1,newPassword2);
        // 返回成功
        return new JsonResult<Void>(OK);
    }
